Добрый день! Меня зовут Дмитрий. Я разработчик на Python и это репозиторий с моими работами. В случае возникновения любых вопросов, готов ответить на них по контактам указанным в резюме. 
